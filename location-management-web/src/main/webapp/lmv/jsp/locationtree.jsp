<link rel="stylesheet" href="css/cssmodal/jquery-ui.css?v=${version_css_js}" type="text/css">
<link rel="stylesheet" href="css/cssmodal/zTreeStyle/zTreeStyle.css?v=${version_css_js}" type="text/css">
<link rel="stylesheet" href="css/cssmodal/mystyle.css?v=${version_css_js}" type="text/css">
...
<script src="js/jsmodal/jquery/jquery.min.js?v=${version_css_js}" type="text/javascript"></script>
<script src="js/jsmodal/jquery/jquery.csv.min.js?v=${version_css_js}" type="text/javascript"></script>
<script src="js/jsmodal/bootstrap.min.js?v=${version_css_js}"></script>
<script type="text/javascript" src="js/jsmodal/ztree/jquery.ztree.core.js?v=${version_css_js}"></script>
<script type="text/javascript" src="js/jsmodal/ztree/jquery.ztree.excheck.js?v=${version_css_js}"></script>
<script type="text/javascript" src="js/jsmodal/ztree/jquery.ztree.exedit.js?v=${version_css_js}"></script>
<script src="js/jsmodal/exportcsv/excellentexport.min.js?v=${version_css_js}"></script>
<script>
		...
		<div class="groupBtn" >
			<div id="groupBtn1" class="btn btn-secondary">
				...
				<div id="group">
					...
					data-keyboard="false" title="Add New Location" style="cursor:pointer" class="icon" ><img src='images/plus.png' width='25px' height='25px'></a>
				</div>
			</div>
		</div>
		...
		<div class="groupBtn" >
			<div id="groupBtn1" class="btn btn-secondary">
				...
				<div id="group">
					...
					<a id="updateLocationTypeBtn" onclick="openLocationTypeEditForm();" style="cursor:pointer" class="icon" ><img src='images/edit-icon.png' width='25px' height='25px'></a>
					<a id="viewLocationTypeBtn" data-toggle="modal" data-target="#myModalLocationTypeView" data-backdrop="static" data-keyboard="false" title="View Location Type" onclick="viewLocationTypeDetails();" style="cursor:pointer" class="icon" ><img src='images/viewDetail.png' width='25px' height='25px'></a>
				</div>
			</div>
			<div id="groupBtn2" class="btn btn-secondary">
				...
				<div id="group">
					...
					<a id="updateLocationAttributeTypeBtn" onclick="openLocationAttributeTypeEditForm();" style="cursor:pointer" class="icon" ><img src='images/edit-icon.png' width='25px' height='25px'></a>
					<a id="viewLocationAttributeTypeBtn" data-toggle="modal" data-target="#myModalLocationAttributeTypeView" data-backdrop="static" data-keyboard="false" title="View Location Attribute Type" onclick="viewLocationAttributeTypeDetails();" style="cursor:pointer" class="icon" ><img src='images/viewDetail.png' width='25px' height='25px'></a>
				</div>
			</div>
		</div>
...
<script type="text/javascript" src="js/jsmodal/myscript.js?v=11111${version_css_js}"></script>
